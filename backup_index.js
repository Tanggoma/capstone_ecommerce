...
// //     res.send({ decodedSessionId: req.decodedSid });
// // });
...
// // app.use('/api/products', requireUser, productsRouter);
// app.use('/api/products', requireUser, decodeSid, productsRouter);
// // app.use('/api/carts', userOrGuest, cartsRouter);
// // app.use('/api/carts', requireUser, cartsRouter); // version 2  works with logged user
